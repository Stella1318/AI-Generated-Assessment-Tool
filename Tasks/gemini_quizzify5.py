...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/workspaces/codespaces-blank/gemini-quizzify-428422-530e85f7c8c3.json'
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        for page in self.processor.pages:
            texts.extend(text_splitter.split_text(str(page)))
        ...
        self.db = Chroma.from_documents(documents, self.embed_model.client, persist_directory="./chroma_db")
...
if __name__ == "__main__":
    processor = PDFProcessor() # Initialize from Task 3
